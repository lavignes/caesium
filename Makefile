...
CFLAGS = -Iinclude/ -g -Wall -Wextra -Werror -Wno-unused-result -Wno-missing-field-initializers -Wno-unused-parameter -Wno-unused-but-set-parameter -Wno-unused-function -std=gnu99 -DCS_DEBUG
LDFLAGS = -L$(LIB_DIR)/
